  ...
  if (isLoading) {
    return (
      <Card className="bg-card border-border">
        <CardHeader>
          <CardTitle className="text-lg font-semibold text-card-foreground">Recent Comments</CardTitle>
        </CardHeader>
        <CardContent>
                ...
                <div className="flex-1 space-y-2">
                  <div className="flex items-center justify-between gap-2 flex-wrap">
                    <div className="flex items-center gap-2">
                      ...
                      <Badge variant="secondary" className="bg-chart-1 text-primary-foreground">
                        TikTok
                      </Badge>
                      {comment.isBot && (
                  ...
                  <p className="text-sm text-card-foreground leading-relaxed">{commentText}</p>
                  <div className="flex items-center gap-2">
                    <Badge
                      variant="outline"
                      className={
                    ...
                    {comment.digg_count > 0 && (
                      <span className="text-xs text-muted-foreground">❤️ {comment.digg_count}</span>
                    )}
                  </div>
                </div>
              </div>
