        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              AI-powered threat assessment and insights extraction
            </p>
          </div>
          <Button
            variant="outline"
          ...
          <div className="space-y-6">
            ...
            <div
              className={`p-4 rounded-lg border ${getThreatLevelColor(
                intelligence.threatLevel?.level
              )}`}
            >
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm mb-2">
                    {intelligence.threatLevel?.description}
                  </p>
                  {intelligence.threatLevel?.indicators &&
                    intelligence.threatLevel.indicators.length > 0 && (
                      <div className="mt-3">
                        <p className="text-xs font-medium mb-2">
                          Key Indicators:
                        </p>
                        <ul className="text-xs space-y-1">
                          {intelligence.threatLevel.indicators.map(
            ...
            {intelligence.keyEntities && (
              <div className="p-4 rounded-lg bg-muted/30 border border-border/50">
                ...
                <div className="grid gap-3 md:grid-cols-3">
                  {intelligence.keyEntities.people &&
                    intelligence.keyEntities.people.length > 0 && (
                      <div>
                        <p className="text-xs font-medium text-muted-foreground mb-2">
                          People
                        </p>
                        <div className="flex flex-wrap gap-1.5">
                          {intelligence.keyEntities.people.map(
                            (person: string) => (
                              <Badge
                                key={person}
                                variant="secondary"
                  ...
                  {intelligence.keyEntities.organizations &&
                    intelligence.keyEntities.organizations.length > 0 && (
                      <div>
                        <p className="text-xs font-medium text-muted-foreground mb-2">
                          Organizations
                        </p>
                        <div className="flex flex-wrap gap-1.5">
                          {intelligence.keyEntities.organizations.map(
                            (org: string) => (
                              <Badge
                                key={org}
                                variant="secondary"
                  ...
                  {intelligence.keyEntities.locations &&
                    intelligence.keyEntities.locations.length > 0 && (
                      <div>
                        <p className="text-xs font-medium text-muted-foreground mb-2">
                          Locations
                        </p>
                        <div className="flex flex-wrap gap-1.5">
                          {intelligence.keyEntities.locations.map(
                            (location: string) => (
                              <Badge
                                key={location}
                                variant="secondary"
            ...
            {/* Behavioral Patterns */}
            {intelligence.behavioralPatterns &&
              intelligence.behavioralPatterns.length > 0 && (
                <div className="p-4 rounded-lg bg-muted/30 border border-border/50">
                  <div className="flex items-center gap-2 mb-3">
                  ...
                  <div className="space-y-2">
                    {intelligence.behavioralPatterns.map(
            ...
            {/* Emerging Trends */}
            {intelligence.emergingTrends &&
              intelligence.emergingTrends.length > 0 && (
                <div className="p-4 rounded-lg bg-muted/30 border border-border/50">
                  <div className="flex items-center gap-2 mb-3">
                  ...
                  <div className="space-y-2">
                    {intelligence.emergingTrends.map(
