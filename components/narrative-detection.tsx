...
import { MessageSquare, TrendingUp, Users, Sparkles, RefreshCw, AlertCircle } from "lucide-react"
      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground">AI-powered analysis of key discussion themes</p>
          </div>
        ...
        {isLoading || isAnalyzing ? (
          <div className="h-[200px] flex items-center justify-center text-muted-foreground">
            <div className="flex items-center gap-2">
              ...
              {isAnalyzing ? "AI is analyzing narratives..." : "Loading comments..."}
            </div>
          </div>
        ) : error ? (
          ...
          <div className="space-y-6">
              ...
              <div className="p-4 rounded-lg bg-primary/5 border border-primary/20">
                <div className="flex items-start justify-between mb-2">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="font-semibold text-card-foreground">Primary Discussion</h3>
                  </div>
                  <Badge
                    variant="outline"
                    className={
                ...
                <h4 className="text-base font-medium text-card-foreground mb-2">{aiNarratives.mainNarrative.title}</h4>
                <p className="text-sm text-muted-foreground mb-3">{aiNarratives.mainNarrative.description}</p>
                <div className="flex items-center gap-2 mb-3 text-xs text-muted-foreground">
                  <Users className="h-3 w-3" />
                  <span>~{aiNarratives.mainNarrative.percentage}% of comments</span>
                </div>
                <div className="flex flex-wrap gap-2">
                  {aiNarratives.mainNarrative.keywords.map((keyword: string) => (
            ...
            {aiNarratives.secondaryNarratives && aiNarratives.secondaryNarratives.length > 0 && (
              <div>
