...
const narrativeSchema = z.object({
  mainNarrative: z.object({
    ...
    description: z.string().describe("A brief explanation of what people are saying about this topic"),
    sentiment: z.enum(["positive", "negative", "neutral"]).describe("Overall sentiment of the main narrative"),
    keywords: z.array(z.string()).describe("Key terms and phrases related to this narrative"),
    percentage: z.number().describe("Estimated percentage of comments discussing this topic"),
  }),
...
4. Estimate the percentage of comments for each narrative based on the sample`,
    ...
    return Response.json({ error: "Failed to analyze narratives" }, { status: 500 })
  }
}
