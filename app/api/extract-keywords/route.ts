...
export async function POST(request: Request) {
  try {
    ...
    console.log("[v0] Extracting keywords from", sampledComments.length, "comments")
    ...
    try {
      const { object } = await generateObject({
        ...
        prompt: `Extract the top 10 most meaningful keywords from these comments.
...
${commentsText}`,
      ...
      console.log("[v0] AI extracted keywords:", object.keywords.length)
      ...
      console.log("[v0] AI extraction failed, using fallback method")
